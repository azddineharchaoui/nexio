...
document.getElementById('validate').addEventListener('click', function() {
    ...
    // Loop through the items in the cart and add details to the confirmation message
    panier.forEach(item => {
    ...
    // Reset the quote (devis) and totals in the UI
    const liste = document.getElementById("listDevis");
    liste.innerHTML = '';  // Clear the products list
