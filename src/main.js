document.addEventListener('DOMContentLoaded', function () {
  ...
  let ligneCmd = {id_ligneCmd:"" ,produit :"", prixUnitaire:0 , qte:0 , prix:0 }
  ...
  const TypeProcesseurPc = [
      ...
      { id :7  , id_processeur :1  , marque: "AMD", nom: "AMD Ryzen 5 5600G", prix: 70 },
      { id :8  , id_processeur :2  , marque: "Intel", nom: "Core i3-13100F", prix: 10 },
      {id :9 ,  id_processeur :2  , marque: "Intel", nom: "Core i5-13600K", prix: 20 },
      {id :10 ,  id_processeur :2  , marque: "Intel", nom: "Core i9-13900K", prix: 40 },
      {id :11  ,  id_processeur :2  , marque: "Intel", nom: "Core i7-13700K", prix: 50 },
      { id :12  , id_processeur :2  , marque: "Intel", nom: "Intel Core i5-13400", prix: 60 }
    ]
  ...
  function afficheDetail(id_produit){
    let prod = getproduit(id_produit);
    let card = document.createElement('card');
    let codeHtml = ` <div class="product-card flex   border-2 border-gray-200 m-2.5  p-2.5">
                <img class="w-1/2 h-100  m-10" src="img/laptop1.jpg" alt="${prod.nom}">
                <div class="flex flex-col justify-center p-10 ">
                    <h3 class="text-4xl font-normal tracking-normal  leading-10">${prod.nom}-${prod.spec}</h3>
                    <br>
                    <p class="text-4xl">Prix : ${prod.prix} </p>
                </div>
            </div>
    `;
    card.innerHTML = codeHtml ; 
 ...
 //https://stackoverflow.com/questions/11957677/html-how-to-get-custom-attribute-of-option-tag-in-dropdown
  selectStockagePhone.addEventListener("change" , function(){
        ...
        calculPrixProduit(prodAfficheSurPageDetail, prix)
  })
...
function calculPrixProduit(prod, prixOption){
 // ; 
